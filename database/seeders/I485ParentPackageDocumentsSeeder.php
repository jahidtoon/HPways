...
class I485ParentPackageDocumentsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $canonical = collect([
            ...
            ['code'=>'REL_OUT_OF_WEDLOCK','label'=>'If father and child born out of wedlock: proof of legitimation or emotional/financial relationship','required'=>0],
            ...
            ['code'=>'SEC_MEDICAL_RECORDS','label'=>'Medical/health records naming both parent and child','required'=>0],
            ['code'=>'SEC_CHURCH_RECORDS','label'=>'Church/religious records listing parent and child','required'=>0],
            ['code'=>'SEC_INSURANCE','label'=>'Insurance records naming both petitioner and beneficiary','required'=>0],
            ['code'=>'SEC_EMPLOYMENT_RECORDS','label'=>'Employment records showing parent and child','required'=>0],
            ['code'=>'SEC_TAX_FINANCIAL','label'=>'Financial records (tax returns) listing parent and child','required'=>0],
            ...
            // Parent identity & immigration
            ['code'=>'PARENT_BIRTH_CERT','label'=>'Parent’s birth certificate (certified English translation if needed)','required'=>1],
            ...
            // Petitioner Financial Affidavit
